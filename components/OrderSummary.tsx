    ...
    <div className="sticky top-24">
        <div className="bg-gray-50 rounded-lg p-6 border border-gray-200">
            ...
            <div className="border-t border-b border-gray-200 divide-y divide-gray-200">
                {order.length === 0 ? (
                <p className="text-gray-500 text-center py-12 text-lg">Add items to get started</p>
                ) : (
                        ...
                        <div key={item.id} className="flex items-center justify-between py-4">
                            <div className="flex items-center gap-3">
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="font-bold w-5 text-center text-base">{item.quantity}</span>
                            ...
                            <p className="text-base text-gray-600 font-medium">${(item.price * item.quantity).toFixed(2)}</p>
                        </div>
                    ))}
                </div>
                )}
        ...
        <button
            ...
            className="w-full mt-4 bg-gray-900 text-white font-bold py-4 rounded-lg hover:bg-gray-700 disabled:bg-gray-300 disabled:cursor-not-allowed transition-all flex justify-between items-center px-6 text-lg"
        >
